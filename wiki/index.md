...
- [release-distribution.md](conventions/release-distribution.md) — release, distribution, GitHub Actions (ci.yml / release.yml), macos-26 arm64, version inject (`Version.swift`, tag source of truth), tarball + sha256, Homebrew tap `wcgomes/tap`, formula template, curl/tar fallback, COPYFILE_DISABLE, notarize deferred, prerelease `-` flag
