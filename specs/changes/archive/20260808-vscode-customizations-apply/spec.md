...
Delta against realized contract `specs/adevcontainer/spec.md`. RFC 2119 keywords apply. Prior related contract: archived `vscode-open-flag` (open soft-fail; postAttach after successful `--vscode` open).
