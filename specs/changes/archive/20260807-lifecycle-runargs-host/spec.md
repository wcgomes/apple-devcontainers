...
Delta against realized contract (union of `specs/<domain>.md`; core in `specs/core.md`). Requirements below are **ADDED** unless marked **MODIFIED**.
...
Extends **Supported property surface (core)** in `specs/core.md`.
