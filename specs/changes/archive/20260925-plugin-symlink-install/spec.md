...
This delta is the authoritative contract. Overlapping requirements in the corrected [install-plugin-command](../20260925-install-plugin-command/spec.md) delta match this contract. Where both deltas speak, this change is the contract.
